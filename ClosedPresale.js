...
contract Crowdsale {
  ...
  function Crowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet, TorgimToken _token) public {
...
contract ElementhCrowdsale is CappedCrowdsale, RefundableCrowdsale {
  ...
  function TorgimCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, uint256 _capETH, uint256 _goalETH, address _wallet, uint256 _BTCRate, TorgimToken _token) public
    ...
    Crowdsale(_startTime, _endTime, _rate, _wallet, _token){
      BTCRate = _BTCRate;
      bonusStage1 = 50;
      bonusStage2FirstDay = 35;
      bonusStage2SecondDay = 25;
      stage = 1;
    }
